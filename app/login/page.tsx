  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-sm border-border">
        ...
        <CardContent className="p-5 pt-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-11 text-sm" type="button">
          ...
          <p className="mt-5 text-center text-xs text-muted-foreground">
            ...
            <Link href="/signup" className="font-medium text-primary hover:underline active:opacity-70">
              Sign up
            </Link>
          </p>
        </CardContent>
      ...
      <p className="mt-6 text-center text-[10px] text-muted-foreground">
        ...
        <Link href="/terms" className="underline active:opacity-70">
          Terms of Service
        </Link>{" "}
        and{" "}
        <Link href="/privacy" className="underline active:opacity-70">
          Privacy Policy
        </Link>
      </p>
    </div>
